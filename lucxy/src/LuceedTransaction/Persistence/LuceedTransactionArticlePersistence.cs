...
public class LuceedTransactionArticlePersistence : LucxyCorePersistence {
    public LuceedTransactionArticlePersistence(NpgsqlConnection connection) : base(connection)
    {
    }
